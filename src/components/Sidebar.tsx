...
import { MdOutlineQuiz,MdOutlineManageAccounts,MdOutlineVideoCameraBack } from "react-icons/md";
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-50 flex h-screen w-48 flex-col overflow-y-hidden border-r-[1px] border-gray-200 bg-white  duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          {/* <img src={``} className=' max-h-32' alt="Logo" /> */}
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SideNavbarItem to={"/quiz"} icon={<MdOutlineQuiz />} label={'Quiz'} />
              <SideNavbarItem to={"/videos"} icon={<MdOutlineVideoCameraBack />} label={'Videos'} />
              <SideNavbarItem to={"/settings"} icon={<MdOutlineManageAccounts />} label={'Account'} />

...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-50 flex h-screen w-48 flex-col overflow-y-hidden border-r-2 border-gray-200  duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
